...
while True:
    ...
    if str(time.localtime().tm_mon) in ["3","4","5"]:
        ...
        season_image = Image.open('spring.jpg').convert('RGBA')
        ...
        season_image = Image.open('summer.jpg').convert('RGBA')
        ...
        season_image = Image.open('./autumn.jpg').convert('RGBA')
        ...
        season_image = Image.open('winter.jpg').convert('RGBA')
